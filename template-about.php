        ...
        <div class="row">
                ...
                <div class="item-inner">
                    <div class="row">
                        <figure class="figure col-md-5 col-sm-12 col-xs-12">
                            <img class="img-responsive" src="<?= get_template_directory_uri(); ?>/dist/images/team/member-1.jpg" alt=""/>
                        </figure>
            ...
            <div class="item col-md-6 col-sm-6 col-xs-12">
                <div class="item-inner">
                    <div class="row">
                        <figure class="figure col-md-5 col-sm-12 col-xs-12">
                            <img class="img-responsive" src="<?= get_template_directory_uri(); ?>/dist/images/team/member-2.jpg" alt=""/>
                        </figure>
                        <div class="info col-md-7 col-sm-12 col-xs-12">
            ...
            <div class="item col-md-6 col-sm-6 col-xs-12">
                <div class="item-inner">
                    <div class="row">
                        <figure class="figure col-md-5 col-sm-12 col-xs-12">
                            <img class="img-responsive" src="<?= get_template_directory_uri(); ?>/dist/images/team/member-3.jpg" alt=""/>
                        </figure>
                        <div class="info col-md-7 col-sm-12 col-xs-12">
            ...
            <div class="item col-md-6 col-sm-6 col-xs-12">
                <div class="item-inner">
                    <div class="row">
                        <figure class="figure col-md-5 col-sm-12 col-xs-12">
                            <img class="img-responsive" src="<?= get_template_directory_uri(); ?>/dist/images/team/member-4.jpg" alt=""/>
                        </figure>
                        <div class="info col-md-7 col-sm-12 col-xs-12">
            ...
            <div class="item col-md-6 col-sm-6 col-xs-12">
                <div class="item-inner">
                    <div class="row">
                        <figure class="figure col-md-5 col-sm-12 col-xs-12">
                            <img class="img-responsive" src="<?= get_template_directory_uri(); ?>/dist/images/team/member-6.jpg" alt=""/>
                        </figure>
                        <div class="info col-md-7 col-sm-12 col-xs-12">
            ...
            <div class="item col-md-6 col-sm-6 col-xs-12">
                <div class="item-inner">
                    <div class="row">
                        <figure class="figure col-md-5 col-sm-12 col-xs-12">
                            <img class="img-responsive" src="<?= get_template_directory_uri(); ?>/dist/images/team/member-5.jpg" alt=""/>
                        </figure>
                        <div class="info col-md-7 col-sm-12 col-xs-12">
